...
public class AutonPortcullisCommandGroup extends CommandGroup {
	...
	public AutonPortcullisCommandGroup() {
		...
		// addSequential(new DriveStraightDistanceCommand(7,.5));//pushes arm under the
		// bar
		// addSequential("Push gate up with the arm");
		// addParallel("move arm backwards so that gate stays up and doesn't kill the
		// robot as it moves forwards");
