...
public class AutonLowBarCommandGroup extends CommandGroup {
	...
	public AutonLowBarCommandGroup() {
		...
		/*
		 * By Zoe REFRENCES Distance between center line and obstacle close ramp ~86.36
		 * in. Distance between center line and obstacle end ramp ~133.61 Width of
		 * Obstacles (short side) ~47.25 Distance between auto start line and center
		 * line ~12 in. Distance between auto start line and obstacle far ramp ~76.36
		 * in. Already brings it to the obstacle
		 */

		/*
		 * SmartDashboard.putString("AutonLowbar", "is now running");
		 * SmartDashboard.putNumber("LowBar Start",AutonSelectorSubsystem.instance.
		 * getStartpos());
		 * SmartDashboard.putNumber("LowBar Shoot",AutonSelectorSubsystem.instance.
		 * getShootpos());
		 * SmartDashboard.putNumber("LowBar Defense",AutonSelectorSubsystem.instance.
		 * getDefense());
		 */
		 ...
		 * DriveStraightDistanceCommand(131,3));//121 addSequential(new PathSorter());
		 */
