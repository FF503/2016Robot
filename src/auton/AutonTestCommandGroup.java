...
//    	addSequential(new autonDriveCommand());
    	...
    	addSequential(new LowerArmCommand());
    	addParallel(new DriveStraightDistanceCommand(105,3));//unsure 81, 111
    	addParallel(new GoToArmPosition(ArmPosition.LOAD, false, true));
    	addSequential(new AnilSTurn(-30, 3, 30, 20)); //*POS4*
*/    	//addSequential(new AnilSTurn(30, 24, -30, 5)); //*POS3*
    	...
    	addSequential(new GoToArmPosition(ArmPosition.TOP, false, false));*/
    	//* POS1
    	/*addSequential(new DriveStraightDistanceCommand(80));
    	addSequential(new AutonTurnPIDCommand(5));
    	addSequential(new DriveStraightDistanceCommand(10));
    	addSequential(new AutonTurnPIDCommand(55));
    	addSequential(new autonDriveCommand());
    	//addParallel(new LowerArmCommand());
    	
    	addSequential(new DriveStraightDistanceCommand(17));
     	addParallel(new StayOnBatterCommand());
   ...
   //*POS1
    	...
    	//*POS2*	
    	/*addSequential(new DriveStraightDistanceCommand(108));
    ...
    //	addSequential(new AutonStopShooterCommand());
    	...
    	/*//*POS4
    	addSequential(new autonSturnCommand(-70,.7,54,22,24));
    	addSequential(new autonDriveCommand());
    	//addParallel(new LowerArmCommand());
    	//addSequential(new AutonTurnPIDCommand(5));
    	addSequential(new DriveStraightDistanceCommand(17));
...
*/    	
    /*	// *POS 5
    	addSequential(new DriveStraightDistanceCommand(126));
    	addSequential(new AutonTurnPIDCommand(-50));
    	addSequential(new autonDriveCommand());
    	//addParallel(new LowerArmCommand());
    	//addSequential(new AutonTurnPIDCommand(-5));
    	addSequential(new DriveStraightDistanceCommand(17));
