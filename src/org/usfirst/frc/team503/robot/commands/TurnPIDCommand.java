...
import org.usfirst.frc.team503.robot.subsystems.VisionSubsystem;
...
public class TurnPIDCommand extends Command {
	...
	protected boolean isFinished() {
		SmartDashboard.putBoolean("Turn On Target",
				Math.abs(NavSensorSubsystem.ahrs.getAngle() - angle) < RobotMap.TURN_PID_TOLERANCE);
