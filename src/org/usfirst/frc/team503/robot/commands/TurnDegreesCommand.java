...
public class TurnDegreesCommand extends Command {
	...
	protected boolean isFinished() {
		return ((NavSensorSubsystem.ahrs.getFusedHeading() <= (turnDegrees + RobotMap.COMPASS_TOLERANCE))
				&& (NavSensorSubsystem.ahrs.getFusedHeading() >= (turnDegrees - RobotMap.COMPASS_TOLERANCE)));
	}
