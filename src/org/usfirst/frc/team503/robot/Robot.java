...
public class Robot extends IterativeRobot {
	...
	public void autonomousPeriodic() {
		...
		/*
		 * if (firstTime = true) { AutonSelectorSubsystem.instance.runSelectedAuton();
		 * firstTime = false; }
		 */
		 ...
		 * NewDrivetrainSubsystem.driveEncoder.getDistance());
		...
		/*
		 * SmartDashboard.putBoolean("armLowerLimitSwitch",
		 * ArmSubsystem.instance.getArmLowerLimitSwitch());
		 * //SmartDashboard.putNumber("Original Compass Heading",
		 * RobotMap.OriginalCompassHeading);
		 * //89SmartDashboard.putNumber("DistanceToGoal",
		 * VisionProcessor.instance.getDriveDistance());
	...
	public void teleopPeriodic() {
		...
		// SmartDashboard.putNumber("Shooter Encoder Speed",
		// ShooterSubsystem.instance.getEncoderSpeed());
		// } else {
