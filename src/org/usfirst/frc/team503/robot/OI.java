...
import org.usfirst.frc.team503.robot.commands.CancelArmCommand;
...
import org.usfirst.frc.team503.robot.commands.ExtendInCommand;
import org.usfirst.frc.team503.robot.commands.ExtendOutCommand;
...
import org.usfirst.frc.team503.robot.commands.ReverseIndexerCommand;
...
import org.usfirst.frc.team503.robot.commands.ToggleManualShootCommand;
import org.usfirst.frc.team503.robot.commands.ToggleShootCommand;
...
public class OI {
	...
	// private static Trigger shootButton = new Trigger(operatorJoystick, 2);
	// //imported, was commented
	...
	private static JoystickButton shiftToHighGearButton = new JoystickButton(driverJoystick, 6); // eventuall make
																									// operator
																									// controlled
	...
	// private static JoystickButton intakeButton = new
	// JoystickButton(driverJoystick, 10);
	private static JoystickButton deflectorButton = new JoystickButton(operatorJoystick, 3);
	// private static JoystickButton goToClimbButton = new
	// JoystickButton(operatorJoystick, 3);
	...
	public static void initialize() {
		...
		// targetButton.whenReleased(new
		// PIDAimCommand(VisionProcessor.instance.getAngle()));//new AimCommand()));
