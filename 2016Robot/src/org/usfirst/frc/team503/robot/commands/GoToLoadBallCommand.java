...
public class GoToLoadBallCommand extends Command {
    ...
    protected void initialize() {
    	...
    	ArmSubsystem.instance.goToArmPosition(ArmPosition.MID);
    }
    ...
    protected boolean isFinished() {
    	return Math.abs(RobotMap.ARM_POSITION_MID - ArmSubsystem.instance.getArmAngle()) < RobotMap.ARM_TOLERANCE;    
    }
