...
public class OI {
	...
	public static void initialize(){
		...
		//lowerDeflectorButton.whenPressed(new LowerDeflectorCommand());
		//raiseDeflectorButton.whenPressed(new RaiseDeflectorCommand());
		...
		//climbButton.whenReleased(new ClimbCommand());
		...
		//extenderOutButton.whenPressed(new ClimberExtenderOutCommand());
